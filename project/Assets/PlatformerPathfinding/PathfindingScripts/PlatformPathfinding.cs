...
public class Pathfinding : MonoBehaviour {
    ...
    */
    ...
    [System.NonSerialized]
    public LayerMask groundAndOnewayLayer;
    [System.NonSerialized]
    ...
    void Awake() {
        ...
        portalLayer = 1 << LayerMask.NameToLayer("portal");
        onewayLayer = 1 << LayerMask.NameToLayer("oneway");
        groundAndOnewayLayer = groundLayer | 1 << LayerMask.NameToLayer("oneway");
    ...
    public void FindPath(object threadLocker) {//GameObject character, Vector3 location) {
        ...
        while (openNodes.Count > 0) {
            ...
            if (currentNode == endNode) { closedNodes.Add(currentNode); break; } else {
    ...
    private void RefreshAreaAroundBlock(GameObject go, bool blockRemoved) {
                ...
                if (xDistance < blockSize * maxJumpBlocksX + blockSize + groundMaxWidth) //
                    ...
                    if (b != a.spawnedFrom && a.pos.y > b.pos.y + blockSize * 0.5f &&
                        ...
                        a.pos.y - b.pos.y > Mathf.Abs(a.pos.x - b.pos.x) * 0.9f - blockSize * 1f &&
                          Mathf.Abs(a.pos.x - b.pos.x) < blockSize * 4f + groundMaxWidth) { //4.7, 4Xjump, +1Y isnt working
                        if (!Physics2D.Linecast(a.pos, b.pos, groundLayer)) {
                            bool hitTest = true;
