...
public class RaycastController : MonoBehaviour {
    ...
    public virtual void Awake() {
        ...
        portalCollision = 1 << LayerMask.NameToLayer("portal");
        ladderCollision = 1 << LayerMask.NameToLayer("ladder");
        groundAndOneway = collisionMask | 1 << LayerMask.NameToLayer("oneway");
        oneway = 1 << LayerMask.NameToLayer("oneway");
    }
