...
[AddComponentMenu("UI/Scroll List Senior")]
...
public class UI_ScrollListSenior : MonoBehaviour
{
    ...
    public GameObject mBackground = null;   //background of list to drag
    ...
    public void Init()
    {
        ...
        {
            AddDragEvent(this.mBackground);
        }
        this.MaxFixPos = 0;
        this.MinFixPos = (this.ItemNum-1)*ItemCost*-1;
